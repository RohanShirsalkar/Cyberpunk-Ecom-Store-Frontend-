                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="relative">
                      ...
                      />
                      {/* <div
                        className={`absolute -top-1 -right-1 px-1 py-0.5 rounded text-xs font-mono font-bold ${
                          item.inStockValue
                            ? item.status === "ONLINE"
                    ...
                    <div className="flex-1">
                      ...
                      {/* {!item.inStock && (
                        <div className="flex items-center space-x-1 mt-1 text-red-400">
